...
var htmlLoggedinMenuCSS = readHTML('./master-frame/loggedinmenu_css.html');
var htmlLoggedinMenuJS = readHTML('./master-frame/loggedinmenu_js.html');
var htmlLoggedinMenu = readHTML('./master-frame/loggedinmenu.html');
...
router.get('/deletevirusimage/:virusId/:imageNumber', function(request, response) {
    ...
    async function deleteImage() {
        ...
        response.write(`<a href="http://localhost:3000/api/editresearchobject/${virusId}" style="display:inline-block; margin-top:20px; padding:10px 20px; background-color:#007BFF; color:#fff; text-decoration:none; border-radius:5px;">Back to Edit Virus</a>`);
