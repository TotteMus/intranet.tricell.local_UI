...
router.get('/', (request, response) => {
    ...
    // Skicka HTML-delar
    response.write(readHTML('./master-frame/head.html'));
    response.write(readHTML('./master-frame/header.html'));
    response.write(readHTML('./master-frame/menu_back.html'));
    response.write(readHTML('./master-frame/infostart.html'));
    ...
    response.write(readHTML('./master-frame/infostop.html'));
    response.write(readHTML('./master-frame/bottom.html'));
    response.end();
});
