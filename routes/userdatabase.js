...
var htmlFooter = readHTML('./master-frame/footer.html');
...
function renderPageTop(request, response, pageTitle) {
    ...
    response.write(readHTML('./master-frame/loggedinmenu_css.html'));
    response.write(readHTML('./master-frame/loggedinmenu_js.html'));
